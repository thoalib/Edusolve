...
function PushNotificationPrompt() {
    ...
    return (
        <div className="sp-card" style={{ background: 'linear-gradient(to right, #eff6ff, #dbeafe)', border: '1px solid #bfdbfe', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
